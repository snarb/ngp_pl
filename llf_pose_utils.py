...
def load_colmap_data(realdir):
    ...
    c2w_mats = np.linalg.inv(w2c_mats) # 20, 4, 4 (with bottom)

    poses = c2w_mats[:, :3, :4].transpose([1, 2, 0]) # Without bottom [0, 0, 0, 1.] row. (3, 4, 20)
...
#gen_poses('/home/ubuntu/repos/nerf-pytorch/data/nerf_llff_data/fern/', match_type = None)